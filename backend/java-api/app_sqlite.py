...
def init_db():
    ...
    products = [
        ...
        (3, 'Ultra-Slim Laptop', 'High-performance laptop', 141299.99, 1, 'LAPTOP-001', 15, 1),
        (4, 'Smart Watch', 'Advanced smartwatch', 2399.99, 1, 'WATCH-001', 30, 0),
        (5, 'Organic Cotton T-Shirt', 'Comfortable organic cotton t-shirt', 929.99, 2, 'SHIRT-001', 100, 0),
        (6, 'Designer Jeans', 'Premium denim jeans', 889.99, 2, 'JEANS-001', 75, 0),
